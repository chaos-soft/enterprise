...
PROTONPATH = '~/.steam/root/compatibilitytools.d/GE-Proton10-9'
...
WINEINET = 'WINEDLLOVERRIDES=wineinet=d'
...
apps['steam firejail haydee'] = f'{FIREJAIL} mangohud steam'
apps['steam firejail'] = f'{MANGOHUD} {FSR} {VKBASALT} {FIREJAIL} steam'
...
apps['ij'] = f'{MANGOHUD} {PFX_SH2} {WINEINET} obs-gamecapture {UMU_RUN} "{IJ}" +com_skipIntroVideo 1'
